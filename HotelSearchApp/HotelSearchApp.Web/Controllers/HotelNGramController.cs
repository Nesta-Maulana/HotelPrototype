...
{
    public class HotelNGramController : Controller
    {
        private readonly IElasticSearchService _elasticSearchService;

        public HotelNGramController(IElasticSearchService elasticSearchService)
        {
        ...
        public async Task<IActionResult> Search(HotelSearchViewModel viewModel)
        {
            ...
            var result = await _elasticSearchService.SearchHotelsNGramAsync(searchParams);

            stopwatch.Stop();

            viewModel.SearchResults = result;
            viewModel.TotalElapsedMilliseconds = stopwatch.ElapsedMilliseconds;
            viewModel.SearchMethod = "N-Gram";
